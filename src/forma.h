...
/*
 * forma_clona — cria uma copia profunda de uma Forma.
 * O clone e completamente independente do original:
 * modificar um nao afeta o outro.
 * Para poligonos, os arrays de pontos sao copiados.
 *
 * pre-condicao : f != NULL
 * pos-condicao : retorna nova Forma identica, ou NULL se falhar
 */
